...
> import First
> import LALR
> import qualified ProduceCode (produceParser)
> import ProduceGLRCode
> import qualified ProduceSMLCode (produceParser)
...
>       optPrint0 cli DumpSML
>                     (putStr $ ProduceSMLCode.produceParser
>                       g
>                       action
>                       goto
>                       (optsToInject target cli)
...
>       let
>           outfile = ProduceCode.produceParser
>                       g
>                       action
>                       goto
>                       (optsToInject target cli)
...
#ifdef DEBUG
> optPrint0 :: [CLIFlags] -> CLIFlags -> IO () -> IO ()
> optPrint0 cli pass =
>       optIO (elem pass cli)

> optPrint :: [CLIFlags] -> CLIFlags -> IO () -> IO ()
> optPrint cli pass io =
>       optPrint0 cli pass (putStr "\n---------------------\n" >> io)
#endif
